...
-(void)showView{
    ...
    line.center = CGPointMake(kFullScreenAdaptiveX(160.f), kFullScreenAdaptiveY(222.f));
    ...
    button.center = CGPointMake(kFullScreenAdaptiveX(160.f), kFullScreenAdaptiveY(392.f));
    [self.contentView addSubview:button];
}

- (void)initAppBgSelect {
    UILabel *title = [KENUtils labelWithTxt:MyLocal(@"subject_bg") frame:(CGRect){kFullScreenAdaptiveX(20.f), kFullScreenAdaptiveY(58.f), 90, 20}
    ...
    left.center = CGPointMake(kFullScreenAdaptiveX(18.f), kFullScreenAdaptiveY(142.f));
...
- (void)initPaiBgSelect {
    ...
    left.center = CGPointMake(kFullScreenAdaptiveX(18.f), kFullScreenAdaptiveY(303.f));
    [self.contentView addSubview:left];
    ...
    UILabel *title = [KENUtils labelWithTxt:MyLocal(@"subject_ka_bei") frame:(CGRect){kFullScreenAdaptiveX(20.f), kFullScreenAdaptiveY(230.f), 90, 20}
                                       font:[UIFont fontWithName:KLabelFontArial size:14] color:[UIColor whiteColor]];
    title.textAlignment = KTextAlignmentLeft;
    [self.contentView addSubview:title];
}
